...
En este artículo se describen los aspectos básicos del uso de las API de JavaScript para Excel para compilar complementos en Excel 2016. Para más información sobre la API de JavaScript para Excel, vea la página de [referencia](excel-add-ins-javascript-api-reference.md).
