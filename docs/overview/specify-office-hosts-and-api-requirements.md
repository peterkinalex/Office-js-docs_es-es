...
# Especificar los hosts de Office y los requisitos de la API
...
### Especificar el esquema del manifiesto del complemento más reciente
...
### Especificar la API de JavaScript más reciente para la biblioteca de Office
...
## Opciones para especificar hosts de Office o requisitos de API
...
- Si el complemento se ejecuta en un host de Office, establezca el elemento **Hosts** en el manifiesto. Para más información, vea [Establecer el elemento Hosts](../../docs/overview/specify-office-hosts-and-api-requirements.md#set-the-hosts-element).
...
## Establecer el elemento Requirements en el manifiesto
...
## Comprobaciones en tiempo de ejecución mediante métodos que no están en un conjunto de requisitos
