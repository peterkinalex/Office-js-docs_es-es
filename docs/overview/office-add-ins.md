...
- Cómo se integra el complemento con Office: - Para los complementos que amplían Word, Excel, PowerPoint y Outlook: Los puntos de extensión nativos que apuntan al complemento se usan para exponer funciones, como los botones de la cinta. 
      - Para complementos que crean nuevos objetos que se pueden integrar: La dirección URL de la página predeterminada que se carga para el objeto.
