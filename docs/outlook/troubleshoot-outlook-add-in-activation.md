...
# Solucionar problemas relacionados con la activación de los complementos de Outlook
...
## ¿Está el buzón de usuario en una versión de Exchange Server que sea, como mínimo, Exchange 2013?
...
- Si puede probar el complemento en Outlook, puede utilizar la sencilla técnica de depuración siguiente que usa el modelo de objetos de Outlook y el Editor de Visual Basic:
     ...
     >  **Note**  Not seeing the  **Developer** tab? See [How to: Show the Developer Tab on the Ribbon](http://msdn.microsoft.com/en-us/library/ce7cb641-44f2-4a40-867e-a7d88f8e98a9%28Office.15%29.aspx) to turn it on. 3. En el Editor de Visual Basic, seleccione  **Vista**,  **Ventana Ejecución**.
      ...
      4. Para mostrar la versión de Exchange Server, escriba lo siguiente en la ventana Ejecución. La versión principal del valor devuelto debe ser igual a o superior a 15.
        ...
        - Si solo existe una cuenta de Exchange en el perfil de usuario:
        ...
        - _emailAddress_ representa una cadena que contiene la dirección STMP principal del usuario. Por ejemplo, si la dirección SMTP principal del usuario es randy@contoso.com, escriba lo siguiente:
...
## ¿Está el complemento deshabilitado?
...
## ¿Son los elementos probados compatibles con complementos de Outlook? ¿Se entregan con una versión de Exchange Server que sea, como mínimo, Exchange 2013?
...
|**Carácter**|**Descripción**|**Secuencia de escape a usar**|
|:-----|:-----|:-----|
|"|Comilla doble|&amp;quot;|
|&amp;|Y comercial|&amp;amp;|
|'|Apóstrofo|&amp;apos;|
...
## Si utiliza una expresión regular, ¿el complemento de lectura se activa en Outlook Web App o en OWA para dispositivos, pero no lo hace en ninguno de los clientes enriquecidos de Outlook?
...
## Si utiliza una regla ItemIs, ItemHasAttachment o ItemHasRegularExpressionMatch, ¿ha comprobado la propiedad de elemento relacionada?
...
- Si el elemento seleccionado es una cita, o si la regla de activación especifica  **BodyAsPlaintext** en **PropertyName**, puede utilizar el modelo de objetos de Outlook y el Editor de Visual Basic en el cliente enriquecido de Outlook para Windows:
      ...
      1. Asegúrese de que las macros estén habilitadas y de que la pestaña **Desarrollador** aparece en la cinta de Outlook. Si no está seguro de cómo hacerlo, consulte los pasos 1 y 2 de [¿Está el buzón de usuario en una versión de Exchange Server que sea, como mínimo, Exchange 2013?](#está-el-buzón-de-usuario-en-una-versión-de-exchange-server-que-sea-como-mínimo-exchange-2013)
    
      2. En el Editor de Visual Basic, seleccione **Vista**, **Ventana Ejecución**.
...
## ¿La aplicación host aplica todas las expresiones regulares a la porción del cuerpo del elemento tal como esperaba?
