# Objeto SearchResultCollection (API de JavaScript para Word)

Contiene una colección de objetos de [intervalo](range.md) como resultado de una operación de búsqueda.
...
|:---------------|:--------|:----------|
|Items|[SearchResult[]](searchresult.md)|Colección de objetos searchResult. Solo lectura.|
