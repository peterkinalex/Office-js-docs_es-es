...
# <a name="settings.removehandlerasync-method"></a>Método Settings.removeHandlerAsync
Elimina un controlador de eventos para el evento **settingsChanged**.

|||
|:-----|:-----|
|**Hosts:**|Access, Excel y PowerPoint|
...
|:-----|:-----|:-----|:-----|
| _eventType_|[EventType](../../reference/shared/eventtype-enumeration.md)|Especifica el tipo de evento que se debe quitar. Obligatorio.||
...
|**Versión**|**Cambios**|
|:-----|:-----|
|1.1|Se ha agregado compatibilidad para Excel y PowerPoint.|
|1.1|Se ha agregado compatibilidad para agregar y quitar controladores de eventos para el evento **SettingsChanged** en complementos de contenido para Access.|
|1.0|Agregado|
