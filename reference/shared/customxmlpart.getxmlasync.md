...
# <a name="customxmlpart.getxmlasync-method"></a>Método CustomXmlPart.getXmlAsync
...
|**Propiedad**|**Usar para**|
|:-----|:-----|
|[AsyncResult.value](../../reference/shared/asyncresult.value.md)|Tener acceso a una **cadena** que contiene el elemento XML del objeto [CustomXmlPart](../../reference/shared/customxmlnode.getnodesasync.md) al que se hace referencia.|
