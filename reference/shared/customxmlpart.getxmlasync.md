...
# Método CustomXmlPart.getXmlAsync
...
|**Propiedad**|**Usar para...**|
|:-----|:-----|
|[AsyncResult.value](../../reference/shared/asyncresult.value.md)|Tener acceso a una **string** que contiene el elemento XML del objeto [CustomXmlPart](../../reference/shared/customxmlnode.getnodesasync.md) referenciado.|
