...
# <a name="projectdocument.addhandlerasync-method"></a>Método ProjectDocument.addHandlerAsync
Agrega de forma asincrónica un controlador de eventos para un evento de cambio en un objeto [ProjectDocument](../../reference/shared/projectdocument.projectdocument.md).
...
| _handler_|**function**|El nombre del controlador de eventos. Obligatorio.|
...
[Evento TaskSelectionChanged](../../reference/shared/projectdocument.taskselectionchanged.event.md)
