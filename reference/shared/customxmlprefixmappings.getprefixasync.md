...
# Método CustomXmlPrefixMappings.getPrefixAsync
...
|:-----|:-----|:-----|:-----|
| _ns_|**cadena**|Especifica el espacio de nombres para el que hay que obtener el prefijo. Requerido.||
...
|**Propiedad**|**Usar para...**|
|:-----|:-----|
|[AsyncResult.value](../../reference/shared/asyncresult.value.md)|Tener acceso a una **string** que contiene el prefijo del espacio de nombres especificado.|
