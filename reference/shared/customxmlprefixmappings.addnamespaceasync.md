...
# Método CustomXmlPrefixMappings.addNamespaceAsync
...
|:-----|:-----|:-----|:-----|
| _prefix_|**cadena**|Especifica el prefijo que se debe agregar a la lista de asignación de prefijos. Requerido.||
| _ns_|**string**|Especifica el espacio de nombres que se debe asignar al prefijo recién agregado. Requerido.||
