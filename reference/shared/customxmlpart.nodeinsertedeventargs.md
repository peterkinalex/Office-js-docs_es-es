...
|**Nombre**|**Descripción**|
|:-----|:-----|
|[isUndoRedo](../../reference/shared/customxmlpart.isundoredo.md)|Determina si el nodo se ha insertado como parte de una acción de deshacer o rehacer del usuario.|
