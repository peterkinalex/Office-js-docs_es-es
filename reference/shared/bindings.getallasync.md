...
# <a name="bindings.getallasync-method"></a>Método Bindings.getAllAsync
...
En la función de devolución de llamada que se ha remitido al método **getAllAsync**, puede usar las propiedades del objeto **AsyncResult** para devolver la siguiente información.



|**Propiedad**|**Usar para**|
|:-----|:-----|
|[AsyncResult.value](../../reference/shared/asyncresult.value.md)|Tener acceso a una matriz que contiene cada enlace creado para el objeto [Bindings](../../reference/shared/bindings.bindings.md) al que se hace referencia|
