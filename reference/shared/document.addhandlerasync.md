...
# <a name="document.addhandlerasync-method"></a>Método Document.addHandlerAsync
...
| _handler_|**object**|La función de controlador de eventos que se va a agregar, cuyo único parámetro es del tipo [DocumentSelectionChangedEventArgs](../../reference/shared/document.selectionchangedeventargs.md). Obligatorio.||
