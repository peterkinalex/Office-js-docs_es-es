...
# Propiedad CustomXmlPart.builtIn
Obtiene un valor que indica si el objeto CustomXMLPart se encuentra integrado.
 ...
 **true** si el elemento XML personalizado está integrado. De lo contrario, devuelve **false**.
