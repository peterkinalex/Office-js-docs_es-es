...
# <a name="tablebinding.deletealldatavaluesasync-method"></a>Método TableBinding.deleteAllDataValuesAsync
Elimina de la tabla todas las filas que no sean encabezados y sus valores, y cambia de forma adecuada a la aplicación host.
...
En la función de devolución de llamada que se ha remitido al método **deleteAllDataValuesAsync**, puede usar las propiedades del objeto **AsyncResult** para devolver la siguiente información.
