...
# <a name="customxmlnode.getnodevalueasync-method"></a>Método CustomXmlNode.getNodeValueAsync
Obtiene de forma asincrónica el valor del nodo.
...
En la función de devolución de llamada que se ha remitido al método **getNodeValueAsync**, puede usar las propiedades del objeto **AsyncResult** para devolver la siguiente información.



|**Propiedad**|**Usar para**|
|:-----|:-----|
|[AsyncResult.value](../../reference/shared/asyncresult.value.md)|Tener acceso a una **cadena** que contiene el valor del nodo al que se hace referencia.|
