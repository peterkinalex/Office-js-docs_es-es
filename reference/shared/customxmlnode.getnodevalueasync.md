...
# Método CustomXmlNode.getNodeValueAsync
Obtiene de forma asíncrona el valor del nodo.
...
|**Propiedad**|**Usar para...**|
|:-----|:-----|
|[AsyncResult.value](../../reference/shared/asyncresult.value.md)|Tener acceso a una **string** que contiene el valor del nodo referenciado.|
