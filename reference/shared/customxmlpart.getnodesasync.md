...
# <a name="customxmlpart.getnodesasync-method"></a>Método CustomXmlPart.getNodesAsync
...
|:-----|:-----|:-----|:-----|
| _xPath_|**string**|Una expresión XPath que especifica los nodos que quiere devolver. Obligatorio.||
