...
# <a name="customxmlnode.getxmlasync-method"></a>Método CustomXmlNode.getXmlAsync
Obtiene de forma asincrónica el XML del nodo.
...
|**Propiedad**|**Usar para**|
|:-----|:-----|
|[AsyncResult.value](../../reference/shared/asyncresult.value.md)|Tener acceso a una **cadena** que contiene el elemento XML del nodo al que se hace referencia.|
