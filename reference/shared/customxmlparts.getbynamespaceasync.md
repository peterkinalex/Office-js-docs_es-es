...
# <a name="customxmlparts.getbynamespaceasync-method"></a>Método CustomXmlParts.getByNamespaceAsync
Obtiene de forma asincrónica una matriz de elementos XML personalizados que coinciden con el espacio de nombres especificado.
...
|:-----|:-----|:-----|:-----|
| _ns_|**string**|El URI del espacio de nombres. Obligatorio.||
...
En la función de devolución de llamada que se ha pasado al método **getByNamespaceAsync**, puede usar las propiedades del objeto **AsyncResult** para devolver la siguiente información.



|**Propiedad**|**Usar para**|
|:-----|:-----|
|[AsyncResult.value](../../reference/shared/asyncresult.value.md)|Tener acceso a una **matriz** de objetos [CustomXMLPart](../../reference/shared/customxmlnode.getnodesasync.md) que coincidan con el espacio de nombres especificado.|
