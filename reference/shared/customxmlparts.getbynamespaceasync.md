...
# Método CustomXmlParts.getByNamespaceAsync
Obtiene de forma asíncrona una matriz de elementos XML personalizados que coinciden con el espacio de nombres especificado.
...
|:-----|:-----|:-----|:-----|
| _ns_|**string**|La URI del espacio de nombres. Obligatoria.||
...
|**Propiedad**|**Usar para...**|
|:-----|:-----|
|[AsyncResult.value](../../reference/shared/asyncresult.value.md)|Tener acceso a una **array** de objetos [CustomXMLPart](../../reference/shared/customxmlnode.getnodesasync.md) que coincidan con el espacio de nombres especificado.|
