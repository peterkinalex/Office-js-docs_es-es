...
# Método ProjectDocument.getResourceFieldAsync
Obtiene de forma asíncrona el valor del campo especificado para el recurso especificado en una vista de recursos.
...
| _fieldId_|[ProjectResourceFields](../../reference/shared/projectresourcefields-enumeration.md)|El ID del campo de destino. Requerido.||
