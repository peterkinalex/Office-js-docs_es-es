...
# <a name="binding.removehandlerasync-method"></a>Método Binding.removeHandlerAsync
...
|:-----|:-----|:-----|:-----|
| _eventType_|[EventType](../../reference/shared/eventtype-enumeration.md)|Especifica el tipo de evento. Obligatorio.||
...
En el ejemplo siguiente se quita el controlador del evento **BindingDataChanged** denominado `onBindingDataChanged`.
