...
# <a name="documentsetselecteddataasync-method"></a>Método Document.setSelectedDataAsync
Escribe datos en la selección actual del documento.

|||
|:-----|:-----|
|**Hosts:** Access, Excel, PowerPoint, Project, Word y Word Online|**Tipos de complementos: ** Panel de tareas, contenido|
