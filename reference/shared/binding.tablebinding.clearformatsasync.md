...
# <a name="tablebinding.clearformatsasync-method"></a>Método TableBinding.clearFormatsAsync
...
|**Propiedad**|**Usar para**|
|:-----|:-----|
|[AsyncResult.value](../../reference/shared/asyncresult.value.md)|Siempre devuelve **undefined** porque no hay ningún objeto ni datos que recuperar al borrar los formatos.|
...
Consulte [ Format tables in add-ins for Excel](../../docs/excel/format-tables-in-add-ins-for-excel.md) (Dar formato a las tablas de los complementos para Excel) para obtener más información.


## <a name="example"></a>Ejemplo

En el ejemplo siguiente se muestra cómo borrar el formato de la tabla enlazada con el identificador "myBinding":
