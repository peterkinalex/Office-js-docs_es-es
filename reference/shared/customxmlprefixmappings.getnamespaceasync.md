...
# <a name="customxmlprefixmappings.getnamespaceasync-method"></a>Método CustomXmlPrefixMappings.getNamespaceAsync
Obtiene de forma asincrónica el espacio de nombres asignado al prefijo especificado.
...
|:-----|:-----|:-----|:-----|
| _prefix_|**string**|Especifica el prefijo para el que obtener el espacio de nombres. Obligatorio.||
...
|**Propiedad**|**Usar para**|
|:-----|:-----|
|[AsyncResult.value](../../reference/shared/asyncresult.value.md)|Tener acceso a una **cadena** que contiene el espacio de nombres asignado al prefijo específico.|
