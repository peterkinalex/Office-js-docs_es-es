...
# <a name="bindings.releasebyidasync-method"></a>Método Bindings.releaseByIdAsync
Elimina el enlace especificado.
...
|:-----|:-----|:-----|:-----|
| _id_|**string**|Especifica el nombre único del enlace que se debe eliminar. Obligatorio.||
...
En la función de devolución de llamada que se ha remitido al método **releaseByIdAsync**, puede usar las propiedades del objeto **AsyncResult** para devolver la siguiente información.



|**Propiedad**|**Usar para**|
|:-----|:-----|
|[AsyncResult.value](../../reference/shared/asyncresult.value.md)|Siempre devuelve **undefined** porque no hay datos o un objeto que recuperar.|
