# <a name="searchresultcollection-object-(javascript-api-for-word)"></a>Objeto SearchResultCollection (API de JavaScript para Word)

Contiene una colección de objetos [range](range.md) como resultado de una operación de búsqueda.
...
|:---------------|:--------|:----------|
|items|[Range[]](range.md)|Colección de objetos de rango que contiene los resultados de la búsqueda. Solo lectura.|
